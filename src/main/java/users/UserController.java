...
public class UserController extends WebMvcConfigurerAdapter {
	...
	public static DBCollection getCollection(String collectionName) throws UnknownHostException, MongoException {
		String uri = "mongodb://ds049180.mongolab.com:49180";
		MongoCredential mongoCredential = MongoCredential.createMongoCRCredential("amitrakesh", "cmpe273_assignment2_amit", "amit@1234".toCharArray());
		MongoClientURI mongoClientURI = new MongoClientURI(uri);

		MongoClient mongoClient = new MongoClient(mongoClientURI);

		DB db = mongoClient.getDB("cmpe273_assignment2_amit");
		db.authenticate("amitrakesh", "amit@1234".toCharArray());
